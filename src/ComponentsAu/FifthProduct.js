...
function SecondProduct() {
  return (
    ...
    <div style={{ textAlign: 'center', padding: '0px', paddingBottom: '0px', width: '80%' }}>
      ...
      <h2 style={{textAlign: 'center', marginTop: '0', paddingTop: '0', marginBottom: '30px'}}>AUD 584,72</h2>
      ...
      <p>We definitely liked this FDA-cleared wrinkle-fighting device, but we simply can’t justify the price. It costs AUD 584,72. Not a typo.</p>

      <p>So, while it is a great LED mask, you can get the same perfecting results for your skin from Novalight for under AUD 350</p><br/>
