    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '50px' }}>
      <div style={{ textAlign: 'left', width: '80%', margin: 'auto auto' }}>
        ...
        <div style={{ marginTop: '80px' }}>
          ...
          <p>We found some great results with LED masks that cost <strong>less than AUD 412,20</strong>. In fact, our top pick was the lowest-priced option!</p>
          <Divider />
        </div>
      ...
      <div className='imgTextWrapper' style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', alignContent: 'center', gap: '30px', width: '100%', margin: 'auto auto' }}>
        ...
        <h2 style={{background: '#818cf8', color: 'white', width: 'fit-content', margin: '15px auto', borderRadius: '25px', padding: '5px', paddingLeft: '20px', paddingRight: '20px'}}>AUD 342.78</h2>
        </div>
        ...
        <div style={{ textAlign: 'left', padding: '20px', paddingBottom: '0px' }}>
          <div className='TextSection'>
            ...
            <p>We used it every day for 20 minutes per day as Novalight suggests to use it between 15 and 30 minutes per day. It was effortless and comfortable, all the while working on ridding us of the signs of sun exposure over the years. And no wonder it works so well… It has LED technology used by NASA to help you address pigmentation, redness, dry skin, and wrinkles. In the end, we couldn’t get over how radiant, flawless, and beautiful it left our skin! The results are truly professional grade. And at 50% off, that means it’s only AUD 342.78. But hurry, you’ll need to order it today to get it at this amazingly low price.</p>
          </div>
          ...
          <div className="ListSection" style={{marginTop: '30px', display: 'flex', flexDirection: 'column', gap: '10px'}}>
            ...
            <Typography component="div">
              <Box sx={{ display: 'flex', alignItems: 'center', fontSize: '14px' }}>
                <Check sx={{ color: 'green', marginRight: '5px' }} /> Currently available at a discounted price of AUD 342.78.
              </Box>
            </Typography>
          </div>
        </div>
      ...
      <div style={{ width: '100%' }}>
        <Button variant="contained" href="https://novalight-uk.com/products/masque-facial-avec-led-novalight" sx={{ fontWeight: 'bold', backgroundColor: '#4ade80', padding: '10px', paddingLeft: '20px', paddingRight: '20px', fontSize: '16px', borderRadius: '10px' }}>👉 The Best Option</Button>
