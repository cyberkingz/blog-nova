...
function SecondProduct() {
  return (
    ...
    <div style={{ textAlign: 'center', padding: '0px', paddingBottom: '0px', width: '80%' }}>
      ...
      <h2 style={{textAlign: 'center', marginTop: '0', paddingTop: '0', marginBottom: '30px'}}>AUD 461,19</h2>

      <p>Current Body has some stellar reviews and was even propelled into stardom on ‘Emily in Paris,’ that show on Netflix.</p>

      <p>Maybe we’d name it our second favorite on the list as it does have a comfortable fit and shows some promising results, but at this price, which was AUD 461,19, we felt a bit of sticker-shock.</p>

      <p>Why pay more when you can get the same results for less than AUD 350.00 ? That’s what we thought!</p><br/>
