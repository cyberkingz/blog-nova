  ...
  return (
    ...
    <div>
      ...
      <div style={{textAlign: 'left', width: '80%', margin: 'auto auto'}}>
          ...
          <p></p>
          <p>However, <strong>an in-office visit could cost as much as AUD 626,54 per session, depending on your location.</strong> Since LED therapy is never a one-and-done deal,<strong> it only makes sense to find a light therapy mask you can use to achieve those same results at home</strong></p>
          <p></p>
