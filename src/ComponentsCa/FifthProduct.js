...
function SecondProduct() {
  return (
    ...
    <div style={{ textAlign: 'center', padding: '0px', paddingBottom: '0px', width: '80%' }}>
      ...
      <h2 style={{textAlign: 'center', marginTop: '0', paddingTop: '0', marginBottom: '30px'}}>CAD 509,31</h2>
      ...
      <p>We definitely liked this FDA-cleared wrinkle-fighting device, but we simply can’t justify the price. It costs CAD 509,31. Not a typo.</p>
