    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '50px' }}>
      <div style={{ textAlign: 'left', width: '80%', margin: 'auto auto' }}>
        ...
        <div style={{ marginTop: '80px' }}>
          ...
          <p>Vi fick bra resultat med LED-masker som kostade mindre än 2097.25 SEK. Faktum är att vårt toppval var det billigaste alternativet!</p>
          <Divider />
        </div>
      ...
      <div className='imgTextWrapper' style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', alignContent: 'center', gap: '30px', width: '100%', margin: 'auto auto' }}>
        ...
        <h2 style={{background: '#818cf8', color: 'white', width: 'fit-content', margin: '15px auto', borderRadius: '25px', paddingLeft: '20px', paddingRight: '20px'}}>2393,78 SEK</h2>
        </div>
        ...
        <div style={{ textAlign: 'left', padding: '20px', paddingBottom: '0px' }}>
          ...
          <div className="ListSection" style={{marginTop: '30px', display: 'flex', flexDirection: 'column', gap: '10px'}}>
            ...
            <Typography component="div">
              <Box sx={{ display: 'flex', alignItems: 'center', fontSize: '14px' }}>
                <Check sx={{ color: 'green', marginRight: '5px' }} /> För närvarande tillgänglig till ett rabatterat pris av 2393,78 SEK.
              </Box>
            </Typography>
          </div>
      ...
      <div style={{ width: '100%' }}>
        <Button variant="contained" href="https://novalight-uk.com/sv-sw/products/masque-facial-avec-led-novalight" sx={{ fontWeight: 'bold', backgroundColor: '#4ade80', padding: '10px', paddingLeft: '20px', paddingRight: '20px', fontSize: '15px', borderRadius: '10px' }}>👉 DET BÄSTA ALTERNATIVET</Button>
