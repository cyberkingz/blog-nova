...
function SecondProduct() {
  return (
    ...
    <div style={{ textAlign: 'center', padding: '0px', paddingBottom: '0px', width: '80%' }}>
      ...
      <h2 style={{textAlign: 'center', marginTop: '0', paddingTop: '0', marginBottom: '30px'}}>3463,00 SEK</h2>
      ...
      <p>Kanske skulle vi kalla det vårt näst bästa alternativ på listan eftersom det har en bekväm passform och visar lovande resultat, men till det här priset, som var 3463,00 SEK, kände vi en viss chock över priset.</p>

      <p>Varför betala mer när du kan få samma resultat för mindre än 2500,00 SEK? Det var vad vi tänkte!</p><br/>
